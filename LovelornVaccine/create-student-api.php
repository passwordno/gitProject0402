    ...
    $data = file_get_contents("php://input", "r");
     if($data !="")
     {
                ...
                ($mydata["號"]!=""))
        {
            ...
            // 計算 SHA-256 哈希值
            $hash = hash("sha256", $p_StudentID);
            // 取得前八個字元作為密碼
            $p_Password = substr($hash, 0, 8);
            ...
            // student
            $sql = "INSERT INTO student(Name, Gender, Class, SetNo, Type, Addent, StudentID, ActiveCount, PassiveCount) VALUES('$p_Name', '$p_Gender', '$p_Class', '$p_SetNo', '$p_Type', '$p_Addent', '$p_StudentID', 0 , 0)";
            ...
            // member
            $sqlMember = "INSERT INTO member(StudentID, passward)  VALUES ('$p_StudentID', '$p_Password')";  
